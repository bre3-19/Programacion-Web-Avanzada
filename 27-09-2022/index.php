    ...
    <body>
        ...
        <section class="h-screen">
            <div class="flex h-screen justify-center items-center">
                <div class="">
                    <div class="">
                        <form class="" action="<?php echo BASE_PATH ?>auth" method="post">
                            ...
                            <div class="mb-6">
                                <input class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" type="text" name="email" value="" placeholder="Enter email">
                            </div>
                            <div class="mb-6">
